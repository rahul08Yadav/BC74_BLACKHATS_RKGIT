...
public class LocationService extends Service {
    ...
    public void onLocationResult(LocationResult locationResult){
        ...
        if(locationResult != null && locationResult.getLastLocation() !=null){
            ...
            Toast.makeText(LocationService.this,latitude + ", " + longitude,Toast.LENGTH_SHORT).show();
                    ...
                    DocumentReference documentReference = db.collection("Location").document(groupId).collection("users").document(userID);
                    ...
                    documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Log.d("LOCATION_SERVICE", "onSuccess: location stored "+ userID);
                        }
    ...
    private void startLocationServices(){
        ...
        builder.setContentTitle("Crime Related Alerts");
        builder.setDefaults(NotificationCompat.DEFAULT_ALL);
        builder.setContentText("Your Location is being Shared...");
